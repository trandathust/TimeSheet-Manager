...
class ReportTimesheetController extends Controller
{
    ...
    public function getTimesheet()
    {
        ...
        return view('giamdoc.report.all_timesheet', compact('year_now', 'salary', 'ctv_id', 'listCTV_all', 'listCTV', 'setting_salary', 'old_year', 'year', 'month'));
    }
    ...
    public function getDetailTimesheet($id, $month, $year)
    {
        ...
        return view('giamdoc.report.detail_timesheet', compact('total_hour', 'money', 'id', 'listCTV', 'user', 'total_money', 'setting_salary', 'old_year', 'year', 'month', 'listTimesheet'));
    }
