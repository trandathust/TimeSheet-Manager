...
<div class="content-wrapper">
    @include('quanlynhansu.general.content-header',['name'=>'TimeSheet'])
                        ...
                        <table id="table_timesheet" class="table table-bordered table-hover">
                            ...
                            <tbody id="table_timesheet_tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('qlns.getDetailTimesheet',['id'=>$item->id,'month'=>$month,'year'=>$year])}}"
                                            class="btn btn-primary btn-sm" role="button" aria-pressed="true">Chi
                                            tiết</a>
                                        <a href="{{route('qlns.getPrintTimesheet',['id'=>$item -> id,'month' => $month,'year' => $year])}}"
                                            class="btn btn-warning btn-sm btnprn" role="button" aria-pressed="true">In
                                            Timesheet</a>
                                        <a href="{{route('qlns.getPrintPayment',['id'=>$item -> id,'month' => $month,'year' => $year])}}"
