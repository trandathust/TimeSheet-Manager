...
class ReportSalaryController extends Controller
{
    ...
    public function getSalary()
    {
        ...
        return view('quanlynhansu.report.salary', compact('year_now', 'salary', 'listCTV', 'setting_salary', 'old_year', 'year', 'month'));
    }
    ...
    public function postSalary(Request $request)
    {
        ...
        return view('quanlynhansu.report.salary', compact('salary', 'listCTV', 'setting_salary', 'old_year', 'year', 'month', 'year_now'));
    }
}
